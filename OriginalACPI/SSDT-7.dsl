 ...
 *
 * Disassembly of SSDT-7.aml, Fri Jul 24 17:01:04 2020
 *
                ...
                If ((Arg0 == One))
                {
                    ...
                    Else
                    {
                        ...
                        If ((((Local0 & 0x4000) == Zero) || (\UDGF != Zero)))
                        {
                            ...
                            {
                                \DBGF = One
                                \DBUP = \_SB.PCI0.LPCB.H_EC.PDPN
                                SPDB (\_SB.PCI0.LPCB.H_EC.PDPN)
                            }
                            ElseIf ((((Local0 & 0x20) == Zero) || ((\DBGF != Zero) && (\_SB.PCI0.LPCB.H_EC.PDPN != \DBUP))))
                            {
